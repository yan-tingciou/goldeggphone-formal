            ...
            <Content>
                <div className="contentStyle">
                    ...
                    <ul className="serviceUl">
                        <li>
                            <img
                                src="https://github.com/yan-tingciou/goldeggphone-formal/blob/main/src/images/service-fix.jpg?raw=true"
                        ...
                        <li className="serviceLiReverse">
                            <img
                                src="https://github.com/yan-tingciou/goldeggphone-formal/blob/main/src/images/service-buy&sell.jpg?raw=true"
                                className="servicePhoto"
                                alt=""
                            />
                            <div className="serviceText">
                        ...
                        <li>
                            <img
                                src="https://github.com/yan-tingciou/goldeggphone-formal/blob/main/src/images/service-phone%20case-1.jpg?raw=true"
                                className="servicePhoto"
                                alt=""
                            />
                            <div className="serviceText">
                        ...
                        <li className="serviceLiReverse">
                            <img
                                src="https://github.com/yan-tingciou/goldeggphone-formal/blob/main/src/images/service-others.jpg?raw=true"
                                className="servicePhoto"
                                alt=""
                            />
                            <div className="serviceText">
